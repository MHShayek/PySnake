...
class Snake:
    def __init__(self, parent_screen, length):
        self.length = length
        self.parent_screen = parent_screen
        self.cube = pygame.image.load("resources/block.jpg").convert()
        self.x = [SIZE] * length
        self.y = [SIZE] * length
        self.direction = 'down'
    ...
    def draw(self):
        for i in range(self.length):
            self.parent_screen.blit(self.cube, (self.x[i], self.y[i]))
        pygame.display.flip()
...
class Game:
    ...
    def show_game_over(self):
        ...
        self.screen.blit(line1, (250, 300))
        line2 = font.render(
            f"Press Enter to play again, Press Escape to exit!", True, (255, 255, 255))
        self.screen.blit(line2, (250, 350))
        pygame.display.flip()
